#Marcel Duda
#Zaciągam k+1 elementów z listy i kładę je na stos o wielkości 8B*(k+1) (złożoność pamięciowa dla dużych n w porównaniu z k można powiedzieć że w miejscu) za każdym razem ściągam ze stosu najmniejszy element i kładę na 
...
#Jeśli lista jest k chaotyczna to najmniejszy element będzie najdalej od początku o maksymalnie k dlatego wystarczy dla pierwszego miejsca zbudować kopiec k elementowy a następnie wykorzystywać go do następnej
...
from zad1testy import Node, list2tab, runtests, tab2list
